...
function generateReport(predictedLabel) {
    ...
    switch (normalizedLabel) {
        ...
        case 'abnormal heartbeat':
            ...
            recommendation = "Consult a doctor for an in-depth evaluation. You may need further diagnostic tests such as an ECG or Holter monitoring, and possibly treatment.";
            break;
